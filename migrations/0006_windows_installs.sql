...
INSERT OR IGNORE INTO jobs (name, type, enabled, interval_seconds, next_run_at, description) VALUES ('windows_install_timeout', 'windows_install_monitor', 1, 60, CURRENT_TIMESTAMP, 'Windows 安装完成回调超时兜底提醒与 RDP 每分钟可用检测');
