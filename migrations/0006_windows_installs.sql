...
INSERT OR IGNORE INTO jobs (name, type, enabled, interval_seconds, next_run_at, description) VALUES ('windows_install_timeout', 'windows_install_monitor', 1, 300, CURRENT_TIMESTAMP, 'Windows 安装完成回调超时兜底提醒与 RDP 可用检测');
