...
服务器管理页提供「🪟 创建 Windows 服务器」。当前开放 Windows Server 2022 稳定路线、Windows Server 2025 简体中文版实验路线和 Windows 11 Enterprise LTSC 2024 实验路线：
