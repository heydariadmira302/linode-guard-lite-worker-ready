...
export function renderWindowsCreateConfirmText(account: PublicAccount, state: Record<string, unknown>): string {
  ...
  return [
    ...
    isW11 ? "ISO：Bot 会自动查找官方 ISO，不需要你输入 ISO URL" : is2025 ? `ISO：使用 Microsoft 官方 Windows Server 2025 ${state.windows_version === "2k25-en" ? "English" : "简体中文"} Evaluation 下载链接` : null,
