import type { TelegramAnswerCallbackQueryPayload, TelegramClientResult, TelegramEditMessagePayload, TelegramMessagePayload } from "../telegram/types";
...
export class TelegramClient {
  ...
  answerCallbackQuery(payload: TelegramAnswerCallbackQueryPayload): TelegramClientResult {
